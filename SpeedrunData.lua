...
Speedrun.Data = {
	...
	stepList = {
		...
		[1263] = { --RG
			...
			[5] = zo_strformat(SI_SPEEDRUN_RG_BEGIN_XALVAKKA),
			[6] = zo_strformat(SI_SPEEDRUN_RG_KILL_XALVAKKA),
		},
		[1344] = { --DSR
			[1] = zo_strformat(SI_SPEEDRUN_DSR_DOGS),
			[2] = zo_strformat(SI_SPEEDRUN_DSR_BEGIN_TWIN),
			[3] = zo_strformat(SI_SPEEDRUN_DSR_KILL_TWIN),
			[4] = zo_strformat(SI_SPEEDRUN_DSR_BEGIN_FIRSTMINI),
			[5] = zo_strformat(SI_SPEEDRUN_DSR_FINISH_FIRSTMINI),
			[6] = zo_strformat(SI_SPEEDRUN_DSR_BEGIN_REEF),
			[7] = zo_strformat(SI_SPEEDRUN_DSR_KILL_REEF),
			[8] = zo_strformat(SI_SPEEDRUN_DSR_BEGIN_TALERIA),
			[9] = zo_strformat(SI_SPEEDRUN_DSR_KILL_TALERIA),
		},
		[1082] = { --BRP
			[1] = "1.1",
			[2] = "1.2",
